...
used by document_throws to look up thrown exception types for external libraries.
...
```
$PUB_CACHE/document_throws/cache/throws/v1/package/<package>/<source_id>/<version>.throws
```

Per SDK version:

```
$PUB_CACHE/document_throws/cache/throws/v1/sdk/<sdk_version>.throws
```

Per Flutter SDK package version:

```
$PUB_CACHE/document_throws/cache/throws/v1/package/<package>/sdk/<flutter_version>.throws
```
